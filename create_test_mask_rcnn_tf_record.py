...
flags.DEFINE_string('images_dir', 'test_images',
                    'Name of directory containing images')
flags.DEFINE_string('masks_dir', 'test_masks',
                    'Name of directory containing masks corresponding to images')
flags.DEFINE_string('bboxes_dir', 'test_bboxes',
                    'Name of directory containing bboxes annotations corresponding to images')
flags.DEFINE_string('tfrecord_filename', 'test_data',
